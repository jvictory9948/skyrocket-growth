...
import { CreditCard, Bitcoin, Wallet, Check, Sparkles } from "lucide-react";
  ...
  return (
    <section className="py-24">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Add Funds</h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Top up your account instantly. Get bonus credits on larger deposits!
          </p>
        </motion.div>
            ...
            <div className="bg-secondary/50 rounded-xl p-4 mb-6">
              ...
              <div className="flex justify-between items-center pt-2 border-t border-border">
                ...
                <span className="text-lg font-bold text-foreground">
                  ${(effectiveAmount * (1 + bonus / 100)).toFixed(2)}
                </span>
              </div>
            </div>
